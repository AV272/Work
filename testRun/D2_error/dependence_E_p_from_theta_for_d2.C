...
void dependence_E_p_from_theta_for_d2(){
    ...
    double m3_arr[2] = {939.565, 938.272};
    ...
    for (int ii=0; ii<2; ii++){
        ...
        for (int i4=0; i4<2; i4++){
            ...
            if (ii==0){
                ...
                TGraph* gr2 = new TGraph(n3_2, theta_T_arr, E_T_arr);
    ...
    c1->cd(1);
    mg->SetTitle("Dependence of E_{kin} from angle (#theta) in lab system for D2 molecule");
